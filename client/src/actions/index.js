...
export const getAllBooks = ()=> dispatch => fetch(url).then(data=> data.json())
...
export const addNewBook =  (input)=> (dispatch) =>{
    axios.post(url, input).then(results=> results.data)
...
export const sortOfList = (typeOfOrder) => {return {type: SORT_OF_LIST, typeOfOrder}}
